    ...
    export class AntennaDictionaryService {
        ...
        constructor(
            ...
            this._stockAntennas = {
                ...
                "RA-100": new Antenna("RA-100", AntennaType.dish, 100000000, 1.1),
                "RA-15": new Antenna("RA-15", AntennaType.dish, 10000000, 1.1),
                "RA-2": new Antenna("RA-2", AntennaType.dish, 200000, 1.15),
